...
public class CommandStudio implements DecreeExecutor {
    ...
    public void download(
        ...
        new CommandIris().download(pack, branch, false, overwrite);
    }
    ...
    public void loot(
        ...
        ta.set(Bukkit.getScheduler().scheduleSyncRepeatingTask(Iris.instance, () ->
        {
            ...
            engine.addItems(true, inv, player.getLocation().getBlock(), new RNG(RNG.r.imax()), tables, InventorySlotType.STORAGE, player.getWorld(), player.getLocation().getBlockX(), player.getLocation().getBlockY(), player.getLocation().getBlockZ(), 1);
        }, 0, fast ? 5 : 35));
